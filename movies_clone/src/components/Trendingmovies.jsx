        ...
        <div className="flex flex-wrap justify-center">
          {
           movies.map((movie)=>
           {
            ...
            <div className={`bg-[url(https://image.tmdb.org/t/p/original//${movie.poster_path})] flex items-end md:h-[35vh] md:w-[200px] h-[25vh] 
                             w-[150px] bg-center bg-cover rounded-xl m-4 hover:scale-110 ease-out duration-300`}>
